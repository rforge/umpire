...
validEngineWithActivity <- function(object) {
...
setValidity("EngineWithActivity", validEngineWithActivity)
...
setMethod("rand", signature(object="EngineWithActivity"),
          function(object, n, ...) {
  x <- callNextMethod()
...
##-----------------------------------------------------------------------------
setMethod("summary", signature(object="EngineWithActivity"),
          function(object, ...) {
  callNextMethod()
